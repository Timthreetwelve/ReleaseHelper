;----------------------------------------------------------------------
; Inno Setup Script for ReleaseHelper
;----------------------------------------------------------------------
...
#define BaseDir              "V:\Source\Repos\ReleaseHelper\ReleaseHelper"
#define MySourceDir          BaseDir + PublishFolder
#define MySetupIcon          BaseDir + "\Images\RH.ico"
#define MyOutputDir          "D:\InnoSetup\Output"

#define MyAppID              "{E214146A-B7FF-4123-AB1F-EB13043CB77E}"
#define MyAppName            "Release Helper"
#define MyAppNameNoSpaces    StringChange(MyAppName, " ", "")
#define MyAppExeName         "ReleaseHelper.exe"
...
#define MyAppSupportURL      "https://github.com/Timthreetwelve/ReleaseHelper"

; -----------------------------------------------------
; Include the localization file. Thanks bovirus!
; -----------------------------------------------------
#include "RHLocalization.iss"
