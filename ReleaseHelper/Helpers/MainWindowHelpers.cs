...
internal static class MainWindowHelpers
{
    ...
    internal static void LogStartup()
    {
        ...
        _log.Info($"{AppInfo.AppName} ({AppInfo.AppProduct}) {AppInfo.AppVersion} is starting");
    ...
    public static string WindowTitleVersionAdmin()
    {
        ...
        return AppInfo.IsAdmin
            ? $"{AppInfo.AppProduct}  {AppInfo.AppVersion} - ({Strings.MsgText_WindowTitleAdministrator})"
